...
#define STRING_CONFIG_H_AUTHOR "(Christoph Honal, CHRZ AM8 SKR)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CHRZ AM8 SKR"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // BIQU H2 at 210 Degree Celsius and 100% Fan
  ...
  #else
    #define DEFAULT_Kp 13.7849
    #define DEFAULT_Ki 0.9846
    #define DEFAULT_Kd 48.2473
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // plus foam padding, plus magnet PEI plate
  #define DEFAULT_bedKp 277.3419
  #define DEFAULT_bedKi 54.1683
  #define DEFAULT_bedKd 946.6606
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 37, -30, -2.5 }
